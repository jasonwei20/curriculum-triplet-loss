...
if __name__ == "__main__":
    ...
    cfg_json_list = [
        # "config/prelim/huff_nc5_sr_c.json",
        # "config/prelim/huff_nc5_sr_r.json",
        # "config/prelim/fewrel_nc5_sr_c.json",
        # "config/prelim/fewrel_nc5_sr_r.json",
        # "config/prelim/huff_nc5_rd_c.json",
        # "config/prelim/huff_nc5_rd_r.json",
        # "config/prelim/huff_nc5_eda_c.json",
        # "config/prelim/huff_nc5_eda_r.json",
    ]
